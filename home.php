...
<body>
    <header>
       ...
       <p class="ppp"> <img src="img/panier.png" alt=""><a href="panier.php" class="paniera">Panier</a></p>
    ...
    <?php
        ...
        while ($i=mysql_fetch_array($res)){ 
            echo "
            <form action='addpn.php' method='post'>
                <div class='boxx'>
                    <div class='img'>
                    ...
                    <div class='btnn'>
                        <input type='submit' value='Add To Panner'>
                    </div>
            </form>
        </div>";
        }
